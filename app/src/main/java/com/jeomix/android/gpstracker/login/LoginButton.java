...
import com.jeomix.android.gpstracker.OnButtonSwitchedListener;
...
//        signUpPaint.setTypeface(Typeface.create(DEFAULT, BOLD));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isLogin) {
            ...
            canvas.drawText("", loginOrX, buttonCenter + dpToPixels(8), orPaint);
            ...
            canvas.drawText("", currentSignUpTextX, buttonCenter + dpToPixels(8), orPaint);

            canvas.drawText("SIGN UP", signUpOrX, currentSignUpTextY, signUpPaint);
        }
    }
